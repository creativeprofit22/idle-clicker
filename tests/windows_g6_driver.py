...
def main() -> int:
    ...
    try:
        ...
        checks.check(data["version"] == 6 and data["threat"] == 0 and data["best_threat"] == 0
                     ...
                     "dynasty 2 saved as v6 at the default Threat 0 with best 0 and 10 Legacy earned, Veteran Cadre unowned, no defense loss cause")
        army = s["labels"]["Army"]
